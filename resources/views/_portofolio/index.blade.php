...
<div id="smooth-wrapper">
      <div id="smooth-content">
            ...
            <div class="row">
              <div class="col-xxl-12 col-12">
                <div class="hero-content ks_fade_anim" data-delay=".5">
                  <h5 class="sub-title">Driving Digital Innovation</h5>
                  <h1 class="title ">
                    Creative Solutions
                    <span>
                      <span class="color-1"> Digital </span>
                      Results
                    </span>
                  </h1>
                </div>
              </div>
              <div class="offset-lg-4 col-xl-8 col-lg-8">
                <div class="inner-box d-flex">
                  <div class="circle-box ks_fade_anim" data-delay=".7" data-duration="1" data-fade-from="top"
                    data-ease="bounce">
                    ...
                    <div class="center-content">
                      <img src="images/home-1/hero/clients.png" alt="">
                    </div>
                  </div>
                  <div class="infu-box ks_fade_anim" data-delay=".7" data-fade-from="right">
                    <p class="text">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a moreIt is</p>
                    <a class="theme-btn-main mt-5" href="page-about.html">
            ...
            <div class="row">
              <div class="col-xl-9 col-12">
                <div class="section-title">
                  ...
                  <h2 class="title text_invert"> Innovators Shaping Excellence with <br /> Unmatched Solutions, Visionary <br /> </h2>
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="offset-xl-1 col-xl-7 col-lg-8 col-md-12">
                <div class="about-content ks_fade_anim" data-delay=".3" data-fade-from="right">
                  <div class="list">
                    <ul>
                      <li><i class="fa-solid fa-circle-check"></i>Creativity Meets Strategy</li>
                      <li><i class="fa-solid fa-circle-check"></i>Innovative Development</li>
                    </ul>
                    <ul>
                      <li><i class="fa-solid fa-circle-check"></i>Design. Develop. Deliver</li>
                      <li><i class="fa-solid fa-circle-check"></i>Unleashing Digital Power.</li>
                    </ul>
                  </div>
                  <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a moreIt is a long established fact that a reader</p>
                  <div class="bottom">
                    <div class="info-box">
                      <div class="experience count-box">
                        <h3 class="num"><span class="count-text" data-speed="3000" data-stop="25"></span></h3>
                        <p>Years Experiences</p>
                      </div>
                      <a class="theme-btn-main" href="page-about.html">
                        <span class="theme-btn-arrow-left"> <i class="far fa-long-arrow-right"></i> </span>
                        <span class="theme-btn">Discover More</span>
                        <span class="theme-btn-arrow-right"> <i class="far fa-long-arrow-right"></i> </span>
                      </a>
                    ...
                    <div class="swiper-slide">
                      <div class="service-one">
                        <div class="card-style">
                          ...
                          <h3 class="title"> Interaction <br /> Design</h3>
                          <ul class="list">
                          ...
                          <div class="icon-box">
                            ...
                            <a class="theme-btn-main style-2" href="page-service-details.html">
                              <span class="theme-btn-arrow-left theme-btn-arrow-small"> <i class="far fa-long-arrow-right"></i> </span>
                              <span class="theme-btn theme-btn-white theme-btn-small ">View Details</span>
                              <span class="theme-btn-arrow-right theme-btn-white theme-btn-arrow-small"> <i class="far fa-long-arrow-right"></i> </span>
                            </a>
                          </div>
                        </div>
                      </div>
        ...
        <!-- / Case Section Start  /-->
        <section id="project" class="case-wrapper case-one section-padding">
          <div class="auto-container">
          ...
          <div class="case-one__slider-inner">
            <div class="swiper case-slider">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <div class="case-one__single-card">
                    <div class="content">
                      <div class="title-info">
                        <p class="sub-title">Graphics</p>
            ...
            <div class="swiper case-slider" dir="rtl">
              <div class="swiper-wrapper">
                <div class="swiper-slide active">
                  <div class="case-one__single-card style-2 active">
                    <div class="content">
                      <div class="title-info">
                        <p class="sub-title">Graphics</p>
                        <h3 class="title">Digital Product Design</h3>
                ...
                <div class="swiper-slide">
                  <div class="case-one__single-card style-2">
                    <div class="content">
                      <div class="title-info">
                        <p class="sub-title">Graphics</p>
                        <h3 class="title">Digital Product Design</h3>
        ...
        <section class="funfact-wrapper funfact-one">
          <div class="auto-container">
            <div class="row align-items-center">
              <div class="col-xl-6 col-lg-8 ks_fade_anim" data-delay=".3" data-fade-from="left">
                <div class="section-title">
                  <div class="sub-title">
                    <div class="dot"></div>
                    <span>Fun Facts</span>
                  </div>
                  <h2 class="title text_invert"> Where Creativity <br /> Transforms Ideas Into <br /> </h2>
                ...
                <div class="get-in-touch">Elevate Your Business with Bold Creativity <a href="page-contact.html">Get in Touch</a></div>
              </div>
              <div class="col-xl-6 col-lg-12">
                <div class="funfact-one__items ks_fade_anim" data-delay=".3" data-fade-from="right">
                  <div class="funfact-one__shape"></div>
                  <div class="funfact-one__single-item count-box style-1">
                    <div class="dot"></div>
                    <h2 class="num"><span class="count-text" data-speed="3000" data-stop="78"></span>%</h2>
                    <h5 class="tag">Satisfied Clients</h5>
                  </div>
                  <div class="funfact-one__items style-2">
                    <div class="funfact-one__single-item count-box style-1">
                      <div class="dot"></div>
                      <h2 class="num"><span class="count-text" data-speed="3000" data-stop="200"></span>+</h2>
                      <h5 class="tag">Projects completed</h5>
                    </div>
                    <div class="funfact-one__single-item count-box style-1">
                      <div class="dot"></div>
                      <h2 class="num"><span class="count-text" data-speed="3000" data-stop="33"></span>+</h2>
                      <h5 class="tag">Team Member</h5>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="marquee-wrapper marquee-one section-padding">
        ...
        <!-- Team Section Start -->
        <section id="team" class="team-wrapper team-one section-padding">
          <div class="auto-container">
            <div class="section-title text-center">
              ...
              <h2 class="title text_invert">Meet Our Experienced <br /> Team People</h2>
            </div>
            <div class="row">
        ...
        <section id="testimonial" class="testimonial-wrapper testimonial-one section-padding section-bg">
          ...
          <div class="auto-container">
            <div class="section-title text-center">
              ...
              <h2 class="title text_invert">Client Feedback <br /> & Success Stories</h2>
            </div>
            <div class="row">
              ...
              <div class="col-xl-9 col-lg-8 col-md-12">
                <div class="testimonial-one__slider-box">
        ...
        <section id="testimonial" class="pricing-wrapper pricing-one section-padding">
          <div class="auto-container">
            <div class="section-title text-center">
              <div class="sub-title">
                <div class="dot"></div>
              ...
              <h2 class="title text_invert">
                Select a plan according to <br />
                your requirements
              </h2>
            </div>
            <div class="row">
              <div class="col-xl-4 col-lg-6 col-md-6 ks_fade_anim" data-delay=".3">
                <div class="pricing-one__single-card">
                  <div class="shape">
                    <img class="shape-1" src="images/home-1/pricing-shape-01.png" alt="" />
                    <div class="shape-2"></div>
                  </div>
                  <div class="head">Basic Plan</div>
                  <div class="price"><sup>$</sup><span>130</span>/ Monthly</div>
                  <div class="discount">Save 35%</div>
                  <ul class="list">
                    <li><i class="fa-solid fa-circle-check"></i>Custom Website Design</li>
                    <li><i class="fa-solid fa-circle-check"></i>Landing Page Design</li>
                    <li><i class="fa-solid fa-circle-check"></i>Your Growth, Our Priority</li>
                    <li><i class="fa-solid fa-circle-check"></i>Efficiency Meets Affordability</li>
                    <li><i class="fa-solid fa-circle-check"></i>Quality Without Compromise</li>
                    <li><i class="fa-solid fa-circle-check"></i>Free Support</li>
                  </ul>
                  <a class="theme-btn-main" href="page-pricing.html">
                    <span class="theme-btn-arrow-left gray-arrow"> <i class="far fa-long-arrow-right"></i> </span>
                    <span class="theme-btn theme-btn-light ">Select Plan</span>
                    <span class="theme-btn-arrow-right gray-arrow"> <i class="far fa-long-arrow-right"></i> </span>
                  </a>
                </div>
              </div>
              <div class="col-xl-4 col-lg-6 col-md-6 ks_fade_anim" data-delay=".5">
                <div class="pricing-one__single-card active">
                  <div class="shape">
                    <img class="shape-1" src="images/home-1/pricing-shape-01.png" alt="" />
                    <div class="shape-2"></div>
                  </div>
                  <div class="head">Popular Plan</div>
                  <div class="price"><sup>$</sup><span>160</span>/ Monthly</div>
                  <div class="discount">Save 45%</div>
                  <ul class="list">
                    <li><i class="fa-solid fa-circle-check"></i>Custom Website Design</li>
                    <li><i class="fa-solid fa-circle-check"></i>Landing Page Design</li>
                    <li><i class="fa-solid fa-circle-check"></i>Your Growth, Our Priority</li>
              ...
              <div class="col-xl-4 col-lg-6 col-md-6 ks_fade_anim" data-delay=".7">
                <div class="pricing-one__single-card">
                  <div class="shape">
                    <img class="shape-1" src="images/home-1/pricing-shape-01.png" alt="" />
                    <div class="shape-2"></div>
                  ...
                  <div class="price"><sup>$</sup><span>190</span>/ Monthly</div>
        ...
        <section id="contact" class="contact-wrapper contact-one section-padding section-bg">
          <div class="contact-one__bg-image bg-cover" style="background-image: url(images/home-1/contact/contact-bg.png)"></div>
          <div class="shape">
          ...
          <div class="auto-container">
            <div class="contact-one__image">
              <img src="images/home-1/contact/contact-image.jpg" alt="" />
            </div>
            <div class="row">
        ...
        <section class="brand-wrapper brand-one section-padding pb-0">
          <div class="auto-container">
            <div class="brand-one__sec-title text-center">
            ...
            <div class="brand-one__content text-center">
              <div class="swiper brand-slider">
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <div class="brand-one__widget">
        ...
        <!-- News Section Start -->
        <section id="news" class="news-wrapper news-one section-padding">
          <div class="auto-container">
            <div class="section-title-area">
              <div class="section-title">
                ...
                <h2 class="title text_invert">
                  News & Articles from <br />
                  the Blog Posts
                </h2>
              </div>
              <a class="theme-btn-main" href="news-grid.html">
                <span class="theme-btn-arrow-left"> <i class="far fa-long-arrow-right"></i> </span>
                <span class="theme-btn">View All News</span>
                <span class="theme-btn-arrow-right"> <i class="far fa-long-arrow-right"></i> </span>
              </a>
            </div>
            <div class="news-one__inner">
              <div class="row">
                <div class="col-xl-4 col-lg-6 col-md-6  ks_fade_anim" data-delay=".4">
                  <div class="news-one__single-card">
                    <div class="image">
                      <img src="images/home-1/news/news-01.jpg" alt="" />
                      <img src="images/home-1/news/news-01.jpg" alt="" />
                    </div>
                    <div class="content">
                      <ul class="list">
                      ...
                      <h3 class="title">
                        <a href="news-details.html">Exploring the future of <br class="d-none d-lg-block" /> innovation</a>
                      </h3>
                      <a href="news-details.html" class="read"><i class="far fa-long-arrow-right"></i>Read More</a>
                    </div>
                  </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6  ks_fade_anim" data-delay=".5">
                  <div class="news-one__single-card">
                    <div class="image">
                      <img src="images/home-1/news/news-02.jpg" alt="" />
                      <img src="images/home-1/news/news-02.jpg" alt="" />
                    </div>
                    <div class="content">
                      <ul class="list">
                      ...
                      <h3 class="title">
                        <a href="news-details.html">Unraveling the Latest <br class="d-none d-lg-block" /> Digital Trends</a>
                      </h3>
                      <a href="news-details.html" class="read"><i class="far fa-long-arrow-right"></i>Read More</a>
                    </div>
                  </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6  ks_fade_anim" data-delay=".7">
                  <div class="news-one__single-card">
                    <div class="image">
                      <img src="images/home-1/news/news-03.jpg" alt="" />
                      <img src="images/home-1/news/news-03.jpg" alt="" />
                    </div>
                    <div class="content">
                      <ul class="list">
